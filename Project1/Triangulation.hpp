...
namespace Triangulation {
	void render(sf::RenderWindow *window, std::vector<int> indices, CONN_T trgltn, const PS_T &P);
	void render(sf::RenderWindow *window, CONN_T trgltn, const PS_T &P);
	void renderPoint(sf::RenderWindow *window, glm::vec2 loc, sf::Color col);
	void renderTrngltn(sf::RenderWindow *window, CONN_T trgltn, const PS_T &P);

	CONN_T triangulate(sf::RenderWindow *window, const PS_T &P);
